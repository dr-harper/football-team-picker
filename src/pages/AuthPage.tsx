...
import { Users, Shuffle, Trophy, Calendar, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-900 via-green-800 to-green-700 dark:from-green-950 dark:via-green-900 dark:to-green-800 p-4">
            <div className="w-full max-w-4xl flex flex-col lg:flex-row gap-6 lg:gap-0 items-center lg:items-stretch">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center lg:pr-10 text-white">
                    ...
                    {pendingLeagueName ? (
                        ...
                        <>
                            ...
                            <div className="bg-white/10 rounded-xl px-5 py-4 mb-6 flex items-center gap-3">
                                <span className="text-3xl">⚽</span>
                                <span className="text-xl font-bold">{pendingLeagueName}</span>
                            </div>
                            <p className="text-white/70 mb-6">
                                {isLogin ? 'Sign in to your account' : 'Create a free account'} to join the league, track availability and get picked for the team.
                            </p>
                            <div className="flex items-center gap-2 text-white/50 text-sm">
                                <ArrowRight className="w-4 h-4" />
                                You'll be added to the league automatically after signing in
                            </div>
                        </>
                    ) : (
                        /* Generic feature pitch */
                        <>
                            <h1 className="text-3xl lg:text-4xl font-extrabold mb-3 leading-tight">
                ...
                <div className="w-full lg:w-1/2 max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8">
                    ...
                    {pendingLeagueName && (
                        <div className="mb-4 text-center bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-xl p-3 lg:hidden">
